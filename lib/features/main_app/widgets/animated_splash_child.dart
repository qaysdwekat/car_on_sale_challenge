      ...
      case SplashScreenTypeConstants.fadeIn:
        {
          return FadeTransition(
            opacity: _animation,
            child: Center(
              child: AppImage(imageUrl: widget.imagePath, fit: widget.boxFit, height: size.height, width: size.width),
            ),
          );
        }
...
enum SplashScreenTypeConstants { fadeIn, zoomIn, zoomOut, topDown }
